...
Welcome to the Cyberpunk 2077 Enhanced Modlist! The modlist is literally the title, Cyberpunk 2077 but better! Better driving handling, guns, enemies, quests, economy and way more! We meticulously adjusted many in game files and curated mods from amazing authors to improve gameplay loops, fix bugs and add quality of life features. We have repeatedly tested the game over hudnreds of hours of gameplay, making sure the list is stable, performance friendly and balanced in terms of gameplay. My vision for this modlist was to not add mods that abstructed the vanilla vision of Cyberpunk 2077's gameplay and lore. I aimed to make it as Immersive and lore friendly as possible. We tried to the best of our ability, along with the help of testers and mod authors to make this list as bug free as possible with CHALLENIGING but balanced combat.

Beyond gameplay, this modlist also brings substantial improvements to visuals and performance, through carefully selected graphic and optimization mods. Ray tracing and path tracing are heavily optimmized, paired along with amazing LUTS from mod authors the game looks amazing while increasing perfomrance at the same time!
...
2. Once mod organizer is open, in the upper right of Mod organizer 2 you will see a dropdown menu beside the "RUN" button, select "Cyberpunk 2077" and click the "RUN" button
